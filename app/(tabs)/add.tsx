    ...
    return (
      <SafeAreaView style={styles.container}>
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          ...
          >
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
            <ScrollView nestedScrollEnabled={true} keyboardShouldPersistTaps="handled" contentContainerStyle={styles.scrollContainer}>
              ...
              <View style={styles.categoryContainer}>
                <CategorySelector type={selectedOption === "Gastos" ? "gasto" : "ingreso"} />
              </View>
            </ScrollView>
            </TouchableWithoutFeedback>
          </KeyboardAvoidingView>

...
import { View, Text, TouchableOpacity, ActivityIndicator, StyleSheet, Alert, Platform, useColorScheme } from "react-native";
...
// MainLayout MOVIDO DENTRO de los providers para tener acceso a hooks
function MainLayout() {
...
// RootLayout CORREGIDO con el orden correcto de providers
